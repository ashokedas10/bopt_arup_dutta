            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="main-card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Configuration Module</strong>
                            </div>
							<div class="aply-lv" style="padding-right: 36px;">
								<a href="{{ url('role/module-config') }}" class="btn btn-default">Add New Config Module <i class="fa fa-plus"></i></a>
							</div>
                            <div class="card-body">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $config->sub_module_name }}</td>
                                            <td>{{ $config->menu_name }}</td>
