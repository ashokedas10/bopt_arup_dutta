...
@endif	
              <form action="{{ url('role/vw-user-config') }}" method="post" enctype="multipart/form-data" style="padding:2% 5%;">
                ...
                <div class="lv-due" style="border:none;">
                    ...
                    <select class="form-control" id="emp_code" name="emp_code" onchange="getEmployeeName()" <?php if(!empty($user->id)){echo 'style="display:none"';}?>>
					...
					<input type="text" name="employee_id" value="<?php if(!empty($user->id)){echo $user->employee_id;} ?>" <?php if(empty($user->id)){echo 'style="display:none"';}?> class="form-control" readonly="1" />
                   ...
                   <div class="col-md-3">
                    ...
                    <input type="text" id="emp_name" name="name" value="<?php if(!empty($user->id)){echo $user->name;}?>" class="form-control" readonly="1">
                   </div>

					<div class="col-md-3">
						<label>User Email</label>
                           <input type="text" name="user_email" value="<?php if(!empty($user->id)){echo $user->email;}?>" <?php if(!empty($user->id)){echo 'readonly';}?> class="form-control">
