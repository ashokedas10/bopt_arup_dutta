                ...
                <div class="main-card">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <strong class="card-title">Payment Received</strong>
                        ...
                        <div class="card-body">
                            <div class="aply-lv" style="padding-right: 17px;margin-bottom:15px;">
                                <a href="{{ url('accountreceivable/view') }}" class="btn btn-default">Add Received Payment <i class="fa fa-plus"></i></a>
                            </div>
...
{{--                                    <th>Vouchaer Date</th>--}}
                                ...
                                @foreach($receivablelisting as $receivelist)
                                    <tr>
                                        ...
                                        <td>{{date('m-d-Y',strtotime($receivelist->created_at))}}</td>
