            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="main-card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Accessories</strong>
                            </div>
							@if(Session::has('message'))										
									<div class="alert alert-success" style="text-align:center;"><span class="glyphicon glyphicon-ok" ></span><em > {{ Session::get('message') }}</em></div>
							@endif	
							<div class="aply-lv" style="padding-right: 36px;">
								<a href="{{ url('masters/accessories') }}" class="btn btn-default">Add New Accessories <i class="fa fa-plus"></i></a>
							</div>
                            <div class="card-body">
							...
							<div class="srch-rslt" style="overflow-x:scroll;">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $accessories->accessories_code }}</td>
                                            <td>{{ $accessories->accessories_name }}</td>
											<td>{{ $accessories->accessories_status }}</td>
