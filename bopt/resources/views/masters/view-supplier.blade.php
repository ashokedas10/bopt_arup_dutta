                    ...
                    <div class="main-card">
                        ...
                        <div class="card">
							...
							<div class="aply-lv" style="padding-right: 36px;">
								<a href="{{ url('masters/supplier') }}" class="btn btn-default">Add New Supplier <i class="fa fa-plus"></i></a>
							</div>
                            <div class="card-body">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<td><a href='{{url("masters/supplier/$supplier->id")}}'><i class="ti-pencil-alt"></i></a>
												</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
