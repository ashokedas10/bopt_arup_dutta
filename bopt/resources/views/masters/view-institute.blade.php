                    ...
                    <div class="main-card">
                        ...
                        <div class="card">
							...
							<div class="aply-lv" style="padding-right: 36px;">
								<a href="{{ url('masters/institute') }}" class="btn btn-default">Add New Institute <i class="fa fa-plus"></i></a>
							</div>
                            <div class="card-body">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									@foreach($institute_rs as $institute)
                                        <tr>
											...
											<td>{{ $institute->institute_location }}</td>
											<td>{{ $institute->institute_status }}</td>
											<td><img src="{{ url('/') }}/storage/app/{{ $institute->logo_name }}" ></td>
