...
<div class="animated fadeIn">
    ...
    <input type="text" id="company_name" name="company_name"<?php echo  request()->has('c_id') ? 'readonly': '' ?> class="form-control" value="{{ request()->has('c_id') ? $CompanyData[0]->company_name: '' }}{{ old('company_name') }}">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-12 col-md-9"><textarea id="company_address" name="company_address" rows=5 class="form-control" >{{ request()->has('c_id') ? $CompanyData[0]->company_address : '' }} {{ old('company_address') }} </textarea>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="company_phone" name="company_phone"  class="form-control" value="{{ request()->has('c_id') ? $CompanyData[0]->company_phone : '' }}{{ old('company_phone') }}">
	                  ...
	                  <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="company_pan" name="company_pan"  class="form-control" value="{{ request()->has('c_id') ? $CompanyData[0]->company_pan : '' }}{{ old('company_pan') }}">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="company_mail" name="company_mail"  class="form-control" value="{{ request()->has('c_id') ? $CompanyData[0]->company_mail : '' }}{{ old('company_mail') }}"></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="disabledSelect" class=" form-control-label">Company CIN <span class="error" >(*)</span></label></div>
                           <div class="col-12 col-md-9"><input type="text" id="company_cin" name="company_cin"  class="form-control" value="{{ request()->has('c_id') ? $CompanyData[0]->company_cin : '' }}{{ old('company_cin') }}">
