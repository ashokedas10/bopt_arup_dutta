                ...
                <div class="row">
                    ...
                    <div class="main-card"> 
                        <div class="card">
                            ...
                            <form action="{{ url('masters/loandetail') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">                                    
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="loan_id" id="loan_id" class="form-control" value="<?php if(!empty($loan_details->loan_id)){ echo $loan_details->loan_id; }  ?>" <?php if(!empty($loan_details->id)){ echo "readonly"; }  ?> required>
