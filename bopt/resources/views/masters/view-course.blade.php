                    ...
                    <div class="main-card">
                        ...
                        <div class="card">
							...
							<div class="aply-lv" style="padding-right: 36px;">
								<a href="{{ url('masters/course') }}" class="btn btn-default">Add New Course <i class="fa fa-plus"></i></a>
							</div>
                            <div class="card-body">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<td>{{ $course->course_family }}</td>
											<td>{{ $course->capacity }}</td>
											<td>{{ $course->effective_start_date }}</td>
