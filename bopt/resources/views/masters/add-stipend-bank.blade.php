                ...
                <div class="row">
                    ...
                    <div class="main-card">
                        <div class="card">
                            ...
                            <form action="{{ url('masters/stipendbank') }}" method="post" enctype="multipart/form-data">
                 ...
                 <option value="{{ $value->id }}" <?php if(!empty($bankdetails[0]['id'])){ if( $bankdetails[0]['bank_name'] == $value->id){  echo "selected"; } } ?>>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="opening_balance" name="opening_balance"  class="form-control" value="{{ (isset($bankdetails[0]['opening_balance']) && !empty($bankdetails[0]['opening_balance']))?$bankdetails[0]['opening_balance']:old('opening_balance')}}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="financial_year" name="financial_year"  class="form-control" value="{{ (isset($bankdetails[0]['financial_year']) && !empty($bankdetails[0]['financial_year']))?$bankdetails[0]['financial_year']:old('financial_year')}}">
