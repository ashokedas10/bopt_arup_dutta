  ...
  <div class="content">
    ...
    <div class="animated fadeIn">
      ...
      <div class="row">
        <div class="main-card">
          <div class="card">
            <div class="card-header"><strong class="card-title"><img src="{{asset('images/product.png')}}" alt="">Add New Item</strong></div>
                ...
                <div class="lv-due" style="border:none;">
                  ...
                  <div class="row form-group lv-due-body">
                    <div class="col-md-4">
                      ...
                      <input type="text" class="form-control" name="item_code" value="<?php if(!empty($item->item_code)){ echo $item->item_code; } ?>">
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="text" class="form-control" id="cname" name="name" value="<?php if(!empty($item->name)){ echo $item->name; } ?>" >
                       @if ($errors->has('name'))
                    ...
                    <label>Category</label>
                      <select class="form-control" id="category_id" name="c_id" onchange="selectSubCategory()" >
                    ...
                    <label>Sub Category</label>
                      <select class="form-control" id="sub_category_id" name="sc_id" >
                    ...
                    <input type="number" class="form-control" name="min_stock" value="<?php if(!empty($item->min_stock)){ echo $item->min_stock; } ?>">
                    ...
                    <input type="number" class="form-control" name="max_stock" value="<?php if(!empty($item->max_stock)){ echo $item->max_stock; } ?>">
                    ...
                    @endif
          					...
          					<div class="col-md-4">
                      <label>Unit</label>
                        <select class="form-control" id="item_unit" name="unit_id" >
          							<option value="" selected="disabled">Select Unit</option>
            							@foreach($unit_rs as $unit)
            							<option value="{{ $unit->id }}" <?php if(!empty($item->unit_id)){ if($unit->id == $item->unit_id) { echo "selected"; } } ?>>{{ $unit->unit_name }}</option>
            							@endforeach
          					     </select>
              					 @if ($errors->has('unit_id'))
              						<div class="error" style="color:red;">{{ $errors->first('unit_id') }}</div>
