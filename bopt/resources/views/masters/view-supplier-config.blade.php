            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="main-card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Supplier Configuration</strong>
                            </div>
							...
							<div class="aply-lv" style="padding-right: 36px;">
								<a href="{{ url('masters/supplier-config') }}" class="btn btn-default">Add New Supplier Configuration <i class="fa fa-plus"></i></a>
							</div>
                            <div class="card-body">
							...
							<div class="srch-rslt" style="overflow-x:scroll;">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
									   ...
									   @foreach($supplier_config_rs as $supplier_config)
                                        <tr> 
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $supplier_config->supplier_name }}</td>											
											<td>{{ $supplier_config->cost_centre_name }}</td>
