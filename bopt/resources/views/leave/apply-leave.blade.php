                ...
                <div class="row">
                    ...
                    <div class="main-card">
                        <div class="card">
							...
							<div class="card-header"><strong class="card-title">Apply for Leave</strong>
								...
								<div class="col-md-4 emp-desc">Date of Application: <span><?php echo date('d-m-Y'); ?></span></div>
									...
									<div class="col-md-4">
                                        <label for="email-input" class=" form-control-label">Leave Type (*)</label>
											...
											<select class="form-control" id="leave_type" name="leave_type" onchange="getLeaveInHand(this.value);">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" readonly="" name="leave_inhand" class="form-control"  id="leave_inhand">
									...
									<div class="col-md-4">
                                        ...
                                        <input type="date" id="from_date" name="from_date" value="{{ old('from_date') }}" placeholder="dd/mm/yyyy" class="form-control" required="">
								   ...
								   <div class="col-md-4">
                                        ...
                                        <input type="date" id="to_date" name="to_date" placeholder="dd/mm/yyyy" value="{{ old('to_date') }}" class="form-control" onchange="get_duration()" required=""><span id="dif"></span>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" readonly="" name="days" class="form-control" id="days" required>
                                        @if ($errors->has('days'))
