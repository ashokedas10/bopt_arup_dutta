                    ...
                    <div class="main-card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">View Tour Status</strong>
                            </div>
							<div class="aply-lv" style="    padding-right: 36px;">
								<a href="{{ url('leave/apply-for-tour') }}" class="btn btn-default">Apply Tour <i class="fa fa-plus"></i></a>
							</div>
                            <div class="card-body">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<td>{{ $tour_apply->tour_status }}</td>
                                            
											<td>
                                                <?php if($tour_apply->tour_status!='APPROVED'){ ?><a href='{{url("leave/apply-for-tour/$tour_apply->id")}}'><i class="ti-pencil-alt"></i></a><?php } ?>
                                            </td>
