            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="main-card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">View Loan Applied</strong>
                            </div>
							<div class="aply-lv" style="    padding-right: 36px;">
								<a href="{{ url('leave/apply-loan') }}" class="btn btn-default">Apply Loan <i class="fa fa-plus"></i></a>
							</div>
                            <div class="card-body">
							...
							<div class="srch-rslt" style="overflow-x:scroll;">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<?php
									$apply_dtarr = explode("-",$loan->apply_date);
									$d = $apply_dtarr[2];
									$m = $apply_dtarr[1];
									$y = $apply_dtarr[0];
									$app_dt = $d."-".$m."-".$y;
