                    ...
                    <div class="main-card">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{ url('leave/apply-for-tour') }}" method="post" enctype="multipart/form-data" style="padding:2% 5%;">
								...
								<input type="hidden" name="apply_date" value="<?php if(!empty($tour_apply->apply_date)){ echo $tour_apply->apply_date;}else{ echo date('Y-m-d'); } ?>">
									...
									<div class="lv-due" style="border:none;">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="purpose" name="purpose" value="<?php if(!empty($tour_apply->purpose)){ echo $tour_apply->purpose;} ?>">
                                    ...
                                    <div class="row form-group" style="margin-top:15px;">
                                        <div class="col-md-3">
                                            <label for="email-input" class=" form-control-label">Advance Required </label>
                                            <input type="text" class="form-control" id="advance_release" name="advance_release" value="<?php if(!empty($tour_apply->advance_release)){ echo $tour_apply->advance_release;} ?>">
