                ...
                <div class="row">
                    ...
                    <div class="main-card">
						...
						<div class="card-header">
							...
							<div class="card-body">
                                <div class="aply-lv"><a href="{{ url('leave/apply-for-tour') }}" class="btn btn-default">Tour Apply <i class="fa fa-plus"></i></a></div>
							</div>
                                    ...
                                    <tbody>
									 @foreach($tour_apply_rs as $tourdtl)
                                        <tr>
                                            ...
                                            <td><a href='{{"tourdtl/$tourdtl->id"}}' target="_blank" style="background: #17a2b8; color: #fff;padding: 5px 10px;">View</a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
