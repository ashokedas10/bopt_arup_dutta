        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{ url('leave/dashboard') }}"><img src="{{ asset('images/dashboard-icon.png') }}" alt="" />Dashboard </a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu"> 
							<li><a href='{{url("pis/employee-profile")}}'> <img src="{{ asset('images/leave-mng.png') }}" alt="" />User Profile</a></li>
                            <li><a href="{{ url('leave/holiday-calendar') }}"><img src="{{ asset('images/leave-app.png') }}" alt="" />Holiday Calendar</a></li>
                            <li><a href="{{ url('leave/apply-leave') }}"><img src="{{ asset('images/leave-app.png') }}" alt="" />Leave Application</a></li>
                            <li><a href="{{ url('leave/tourlisting') }}"><img src="{{ asset('images/daily-att.png') }}" alt="" />Tour Application</a></li>
							<li><a href="{{ url('leave/apply-for-ltc') }}"><img src="{{ asset('images/daily-att.png') }}" alt="" />LTC Application</a></li>
                            ...
                            <li><a href="{{ url('leave/vw-login-logout-status') }}"><img src="{{ asset('images/login-logout.png') }}" alt="" /> Attendance Status</a></li>
							 <li><a href="{{ url('pis/gpf-details') }}"><img src="{{ asset('images/login-logout.png') }}" alt="" /> PF View</a></li>
                        </ul>
                        <?php  } ?>
                    </li>
