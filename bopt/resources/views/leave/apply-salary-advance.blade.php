        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="main-card">
                        <div class="card">
                            <div class="card-header"><strong class="card-title">Salary Advance</strong></div>
                            <div class="card-body card-block">
                                <form action="{{ url('leave/apply-salary-advance') }}" method="post" enctype="multipart/form-data" style="padding:2% 5%;">
								...
								<div class="col-md-4 emp-desc">Date of Application: <span>13.10.2018</span></div>
									...
									<div class="lv-due" style="border:none;">
										...
										<div class="col-md-4">
										<label for="text-input" class=" form-control-label">Salary Advance Amount</label>
										<input type="text" class="form-control" id="salary_advance_amount" name="salary_advance_amount" value="{{ old('salary_advance_amount') }}">
										@if ($errors->has('salary_advance_amount'))
											<div class="error" style="color:red;">{{ $errors->first('salary_advance_amount') }}</div>
										@endif
										</div>
