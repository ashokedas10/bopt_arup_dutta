...
<head>
	...
	<l<link href="{{ asset('theme/assets/css/ars_coolection.css') }}" rel="stylesheet" type="text/css" media="screen">
...
.boxOuter3 .pay-cont{ width:100%; float:left; background:#ffffff; text-align:center; min-height:102px; padding:0px; margin:0px; }
...
<div class="row">
	<div class="col-lg-3">
		<div class="pis-hd">
			<h2>SMS <span>Student Management System</span></h2>
		</div>
		
	<div class="rice-logo">
		<a href="index.php"><img src="{{ asset('theme/images/logo.png') }}" alt=""></a>
	</div>
	</div>
		...
		<div class="payroll-main">
			...
			<div class="col-lg-3">
				...
				<div class="pay-cont">
					...
					<a href="{{ url('sms/fees-management') }}" target="_blank">Start</a>
				</div>
			</div>
			</div>
			...
			<div class="col-lg-6">
				<div class="pay-icon">
				<img src="{{ asset('theme/images/attedence-icon.png') }}" alt="payroll">
				</div>
				<div class="pay-cont">
					<h3>Admission Management</h3>
					<div class="clearfix"></div>
					<a href="{{ url('sms/admission') }}" target="_blank">Start</a>
				</div>
			</div>
			</div>
			...
			<div class="col-lg-3">
				...
				<div class="pay-cont">
					...
					<div class="clearfix"></div>
					<a href="{{ url('sms/routine-management') }}">Start</a>
				</div>
			</div>
			</div>
			...
			<div class="col-lg-6">
				...
				<img src="{{ asset('theme/images/hr.png') }}" alt="payroll">
				</div>
				<div class="pay-cont green" style="min-height: 216px;">
					<h3>Exam Management</h3>
					<div class="clearfix"></div>
					<a href="{{ url('sms/exam-management') }}">Start</a>
				</div>
			</div>
			</div>
			...
			<div class="col-lg-3">
				...
				<img src="{{ asset('theme/images/intervw.png') }}" alt="intervw">
				</div>
				<div class="pay-cont pink">
					<h3>Result Management</h3>
					<div class="clearfix"></div>
					<a href="{{ url('sms/result-management') }}" target="_blank">Start</a>
				</div>
			</div>
			</div>
			...
			<div class="col-lg-3">
				...
				<div class="pay-cont">
					...
					<div class="clearfix"></div>
					<a href="{{ url('sms/room-management') }}" target="_blank">Start</a>
				</div>
			</div>
			</div>
			<div class="clearfix"></div>
