...
<html lang="en">
<head>
  <title>Board of Practical Training | Dairy Register</title>
  <meta charset="utf-8">
...
body {-webkit-print-color-adjust: exact;}
	...
	.sal-det tr td p{text-align:right;margin:0;}.mon{text-align:right;}.mon h3{color:#0099be;margin:0;font-size:25px;}.mon h4{margin:0;text-align:center;font-size:24px;}
	...
	<!-----------company-details----------->
		...
		<tr>
			...
			<td>
				...
				<div class="mon">
					<h4>Reciept Register from <?php echo $to_date; ?> to <?php echo $from_date; ?> </h4>>
				</div>
			</td>
			</tr>
		</table>	
	...
	<!--------------employee-details--------------->
		...
		<table border="1" class="emp-det" style="width:100%;border-collapse:collapse;border-color:#cacaca;">
			...
			<tbody>
				...
				<?php $i=0; foreach($receipt_details as $receipt){ $i++;?>
				<tr>
					<td><?php echo $i; ?></td>
					<td><?php echo $receipt->dairy_no; ?></td>
					<td><?php echo $receipt->receipt_type; ?></td>
					<td><?php echo $receipt->sender_name; ?></td>
					<td><?php echo $receipt->reference_no; ?></td>
					<td><?php echo date_format(date_create($receipt->diary_date),"d.m.y"); ?></td>
				</tr>
				<?php  } ?>
