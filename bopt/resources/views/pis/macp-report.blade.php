...
<html lang="en">
<head>
  <title>Board of Practical Training | Promotion Report</title>
  <meta charset="utf-8">
			...
			<table border="1" class="sal-det" style="width:100%;border-collapse:collapse;border-color:#cacaca;">
				...
				<tbody>
					...
					<tr class="part">
						...
						<td><?php echo $macp->current_emp_designation;  ?></td>
						<td style="text-align:right;"><?php echo $macp->current_emp_dept;?></td>
						<td style="text-align:right;"><?php echo $macp->current_emp_basic_pay;  ?></td>
						<td style="text-align:right;"><?php echo date("d/m/Y", strtotime($macp->date_of_promotion)); ?></td>
						<td style="text-align:right;"><?php echo date("d/m/Y", strtotime($macp->created_at)); ?></td>
						<td style="text-align:right;"><?php echo $macp->present_emp_basic_pay;  ?></td>
					</tr>
				<?php $i++; } }?> 
					<!--<tr>
