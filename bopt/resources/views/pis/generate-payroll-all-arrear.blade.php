                ...
                <div class="main-card">
                    <div class="card">
                        <div class="card-header">
                            <strong>Arrear Payroll Generation for All Employee</strong>
                        </div>
                        ...
                        <div class="card-body card-block">
                            <form action="{{url('pis/vw-generate-arrear-payroll-all')}}" method="post" enctype="multipart/form-data" style="width:50%;margin:0 auto;padding: 18px 20px 1px;background: #ecebeb;">
                                {{ csrf_field() }}
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="month_yr" id="month_yr">
                                            ...
                                            <option>04/2019</option>
                                            <option>05/2019</option>
                                            <option>06/2019</option>
                                            <option>07/2019</option>
                                            <option>08/2019</option>
                                            <option>09/2019</option>
                                            <option>10/2019</option>
                                            <option>11/2019</option>
                    ...
                    <div class="card">
                        <!----------------view----------------->
                        <div class="card-header">
                            <strong class="card-title">Arrear Payroll Generation for All Employee</strong>
                        </div>
                        <div class="card-body card-block">
                            <div class="payroll-table table-responsive" style="width:1020px;margin:0 auto;overflow-x:scroll;">
                                <form action="{{url('pis/save-payroll-generation-all-arrear')}}" method="post">
                                    {{csrf_field()}}
