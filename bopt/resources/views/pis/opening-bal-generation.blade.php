        ...
        <div class="main-card">
          <div class="card">
            ...
            <div class="card-body card-block">
              <form action="{{url('pis/opening-bal-generation')}}" method="post" enctype="multipart/form-data" style="width:50%;margin:0 auto;padding: 18px 20px 1px;background: #ecebeb;">
              	{{ csrf_field() }}
