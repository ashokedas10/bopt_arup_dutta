		...
		<tr>
			...
			<td>
				...
				<div class="mon">
                    ...
                    ?>
					<h4>GPF Report from <?php echo $from_date.' - '.$fromdate[1] ; ?> to <?php echo $to_date.' - '.$todate[1] ; ?></h4>
			...
			<tr>
				<td colspan="3" style="padding-bottom: 25px;">In respect of Shri/Smt:  <u><?php echo $employee_ptax[0]->emp_name; ?></u>,  Designation: <u><?php echo $employee_ptax[0]->emp_designation;  ?></u>,  Emp-Code: <u><?php echo $employee_ptax[0]->employee_id; ?></u>, GPF A/C No.: <u><?php echo $employee_ptax[0]->emp_pf_no; ?></u></td>
			</tr>
			<?php } ?>
		</table>	
