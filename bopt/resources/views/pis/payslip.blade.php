		...
		<table border="1" class="emp-det" style="width:100%;border-collapse:collapse;border-color:#cacaca;">
			...
			<tbody>
				...
				<td colspan="2" width="33.33%"><span>Employee Code :</span><br> {{$payroll_rs[0]->employee_id}}</td>
					...
					<td colspan="2" width="33.33%"><span>Department :</span> {{$payroll_rs[0]->emp_department}}</td>
				</tr>
...
<?php $number = $payroll_rs[0]->emp_net_salary;
  ...
  //echo $result . "Rupees  " . $points . " Paise"; ?>
					...
					<tr>
						...
						<td style="font-weight:600;text-align:right;" colspan="4"><span style="float:left;"><?php echo $result . "Rupees"; ?></span>{{$payroll_rs[0]->emp_net_salary}}</td>
					</tr>
				</tbody>
			</table>
