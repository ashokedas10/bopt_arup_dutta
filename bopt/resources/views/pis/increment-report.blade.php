...
<html lang="en">
<head>
  <title>Board of Practical Training | Increment Report</title>
  <meta charset="utf-8">
	...
	<!-----------company-details----------->
		...
		<tr>
			...
			<td>
				...
				<div class="mon">
						<h4><u>Increment Employee Report</u></h4>
				</div>
			</td>
			...
			<table border="1" class="sal-det" style="width:100%;border-collapse:collapse;border-color:#cacaca;">
				<thead>
					<tr>
						...
						<th>Current Basic Pay (<i class="fas fa-rupee-sign"></i>)</th>
				...
				<tbody>
					...
					<tr class="part">
						...
						<td style="text-align:right;"><?php echo $increment->approve_date;  ?></td>
						<td style="text-align:right;"><?php echo $increment->emp_next_increament_date;  ?></td>
