          ...
          <fieldset>
				...
				<div class="col-md-3">
			  	...
			  	<label>Present City Class <span>(*)</span></label>
                    <select class="form-control" name="emp_present_city" required>
	                    ...
	                    <option value="A class City" <?php  if(request()->get('q')!=''){  if($employee_rs[0]->emp_present_city_class=='A class City'){ echo 'selected';} } ?>>A class City</option>
						<option value="B class City" <?php  if(request()->get('q')!=''){  if($employee_rs[0]->emp_present_city_class=='B class City'){ echo 'selected';} } ?>>B class City</option>
						<option value="C class City" <?php  if(request()->get('q')!=''){  if($employee_rs[0]->emp_present_city_class=='C class City'){ echo 'selected';} } ?>>C class City</option>
						<option value="D class City" <?php  if(request()->get('q')!=''){  if($employee_rs[0]->emp_present_city_class=='D class City'){ echo 'selected';} } ?>>D class City</option>
					</select>
			  </div>

			  <div class="col-md-3">
				  	<label>Residential  Distance (in Km.)</label>
	                <input type="text" name="emp_resdential_distance" value="<?php  if(request()->get('q')!=''){ echo $employee_rs[0]->emp_residential_distance; } ?>" class="form-control">
			  </div>
			   <div class="col-md-3">
				   	<label>Home Town</label>
	                <input type="text" name="emp_home_town" value="<?php  if(request()->get('q')!=''){ echo $employee_rs[0]->emp_home_town; } ?>" class="form-control">
			   </div>
            </div>
				...
				<div class="col-md-4">
					...
					<div class="form-check-inline">
					  <label class="form-check-label">
                            ...
                            <input type="radio"  class="form-check-input" value="Employee" <?php  if(request()->get('q')!=''){ if($employee_rs[0]->emp_spouse_working_status=='Employee'){ echo 'checked';} } ?> name="emp_spouse_working" onclick="showHideDiv()" id="emp_spouse_status" checked="checked">Employee
					  </label>
					</div>
				<div class="form-check-inline">
				  <label class="form-check-label">
                   <input type="radio" class="form-check-input" value="House Wife" <?php  if(request()->get('q')!=''){ if($employee_rs[0]->emp_spouse_working_status=='House Wife'){ echo 'checked';} } ?>  name="emp_spouse_working" onclick="showHideDiv()">House Wife
				  </label>
				</div>
				<div class="form-check-inline">
				  <label class="form-check-label">
                                      <input type="radio" class="form-check-input" value="Others" name="emp_spouse_working" <?php  if(request()->get('q')!=''){ if($employee_rs[0]->emp_spouse_working_status=='Others'){ echo 'checked';} } ?> onclick="showHideDiv()">Others
				  </label>
				</div>
				<div class="form-check-inline">
				  <label class="form-check-label">
                                      <input type="radio" class="form-check-input" value="Same Organisation" name="emp_spouse_working" <?php  if(request()->get('q')!=''){ if($employee_rs[0]->emp_spouse_working_status=='Same Organisation'){ echo 'checked';} } ?> onclick="hideDiv()">Same Organisation
				  </label>
				</div>
				</div>
					...
					<div class="col-md-4" id="govt_emp" style="display: none;">
						...
						<div class="form-check-inline">
				  <label class="form-check-label">
                                      <input type="radio" class="form-check-input" value="yes"  name="emp_government" <?php  if(request()->get('q')!=''){ if($employee_rs[0]->emp_government=='yes'){ echo 'checked';} } ?>>Yes
				  </label>
				</div>
				<div class="form-check-inline">
				  <label class="form-check-label">
                     <input type="radio" class="form-check-input" value="no" name="emp_government" <?php  if(request()->get('q')!=''){ if($employee_rs[0]->emp_government=='no'){ echo 'checked';} } ?>>No
				  </label>
				</div>
					</div>
					...
					<div class="col-md-4" id="spouse_quarter" style="display: none;">
						...
						<div class="form-check-inline">
				  <label class="form-check-label">
                      <input type="radio" class="form-check-input" value="yes" name="emp_spouse_quarter" <?php  if(request()->get('q')!=''){ if($employee_rs[0]->emp_spouse_quarter=='yes'){ echo 'checked';} } ?>>Yes
				  </label>
				</div>
				<div class="form-check-inline">
				  <label class="form-check-label">
                        <input type="radio" class="form-check-input" value="no" name="emp_spouse_quarter"  <?php  if(request()->get('q')!=''){ if($employee_rs[0]->emp_spouse_quarter=='no'){ echo 'checked';} } ?>>No
				  </label>
				</div>
					</div>
				</div>
			...
			<div class="row form-group">
				...
				<label>Next Increment Date </label>
                    <input type="text" name="emp_next_increment_date" id="emp_next_increment_date"  value="<?php  if(request()->get('q')!=''){ 

                    	echo date("d/m/Y", strtotime($employee_rs[0]->emp_next_increament_date));
			...
			<div class="col-md-3">
				<label>Till Date</label>
                    <input type="date" name="emp_till_date" value="<?php  if(request()->get('q')!=''){ echo $employee_rs[0]->emp_till_date; } ?>" class="form-control">
			</div>
			...
			<div class="col-md-3">
				<label>Reporting Authority<span>(*)</span></label>
                    <select class="form-control" name="emp_reporting_auth" required>
                        <option value="">Select</option>
			...
			<div class="row form-group">
				<div class="col-md-3">
				<label>Leave Sanctioning Authority<span>(*)</span></label>
                    <select class="form-control" name="emp_lv_sanc_auth" required>
                        <option value="">Select</option>
...
<!--						<th>Action</th>-->
            ...
            <div class="row form-group">
			  ...
			  <label>Blood Group <span>(*)</span></label>
                          <select class="form-control" name="emp_blood_grp" required>
                              <option value="">Select</option>
			...
			<div class="row form-group">
				<div class="col-md-4">
                    ...
                    <input type="text" id="parmenent_mobile" name="emp_pr_mobile" value="<?php  if(request()->get('q')!=''){ echo $employee_rs[0]->emp_pr_mobile; } ?>" class="form-control" required>
				</div>
			</div>	
<!--			------------------------->
          ...
          <!------------pay-details-------------->
            ...
            <div class="row form-group">
				...
				<label>Group Name</label>
                                <select data-placeholder="Choose a Groupe..." name="emp_group" class="form-control">
						<option value="" label="Select">Select</option>
						<option value="A" <?php  if(request()->get('q')!=''){  if($employee_rs[0]->emp_group_name=='A'){ echo 'selected';} } ?>>A</option>
						<option value="B" <?php  if(request()->get('q')!=''){  if($employee_rs[0]->emp_group_name=='B'){ echo 'selected';} } ?>>B</option>
						<option value="C" <?php  if(request()->get('q')!=''){  if($employee_rs[0]->emp_group_name=='C'){ echo 'selected';} } ?>>C</option>
						<option value="D" <?php  if(request()->get('q')!=''){  if($employee_rs[0]->emp_group_name=='D'){ echo 'selected';} } ?>>D</option>											
				</select>
				</div>
				...
				<label>Pay In The Pay Level <span>(*)</span> </label>
                       <select class="form-control" name="emp_payscale" id="emp_payscale" onchange="setbasicpay()" required>
						...
						<?php foreach($payscale_master as $payscale){ ?>
							<option value="<?php echo $payscale->id;?>" <?php if(request()->get('q')!=''){
				...
				<label>Pension Payment Order (PPO).</label>
                    <input type="text" name="emp_pension_no" value="<?php  if(request()->get('q')!=''){ echo $employee_rs[0]->emp_pension_no; } ?>"  class="form-control" >
				</div>
			</div>
			...
			<div class="row form-group">
				...
				<label>PF Type <span>(*)</span></label>
                      <select data-placeholder="Choose a PF..." name="emp_pf_type" class="form-control" required>
						...
						<option value="gpf" <?php  if(request()->get('q')!=''){  if($employee_rs[0]->emp_pf_type=='gpf'){ echo 'selected';} } ?> >GPF</option>
			...
			<div class="row form-group">
				...
				<label>Payment Type</label>
                                <select class="form-control" name="emp_payment_type">
                                    <option value="">Select</option>
                                    <option value="inter bank" <?php  if(request()->get('q')!=''){  if($employee_rs[0]->emp_payment_type=='inter bank'){ echo 'selected';} } ?>>Inter Bank</option>
                                    <option value="intra bank" <?php  if(request()->get('q')!=''){  if($employee_rs[0]->emp_payment_type=='intra bank'){ echo 'selected';} } ?>>Intra Bank</option>
					</select>
				</div>
				<div class="col-md-3">
				...
				<label>IFSC Code <span>(*)</span></label>
                   <input type="text" name="emp_ifsc_code" value="<?php  if(request()->get('q')!=''){ echo $employee_rs[0]->emp_ifsc_code; } ?>" id="emp_ifsc_code" class="form-control" readonly>
				</div>		
			</div>
