...
<div class="payslip">
		...
		<tr>
			...
			<td>
				...
				<div class="mon">
                    ...
                    ?>
					<h4>NPS Report from <u><?php echo $from_date.' - '.$fromdate[1] ; ?></u> to <u><?php echo $to_date.' - '.$todate[1] ; ?></u></h4>
			...
			<tr>
				<td colspan="3" style="padding-bottom: 25px;">In respect of Shri/Smt:  <u><?php echo $employee_ptax[0]->emp_name; ?></u>,  Designation: <u><?php echo $employee_ptax[0]->emp_designation;  ?></u>,  Emp-Code: <u><?php echo $employee_ptax[0]->employee_id; ?></u>, Pran No.: <u><?php echo $employee_ptax[0]->emp_pf_no; ?></u></td>
			</tr>
  ...
  //echo $result . "Rupees  " . $points . " Paise"; ?>
				<td style="font-weight:600;" colspan="2">Total in words: RUPEES <?php echo strtoupper($result); ?>  </td>
