...
@section('content')
   ...
   <div class="content">
			...
			@endif	
			<div class="aply-lv"><a href="{{url('pis/add-payroll-generation')}}" class="btn btn-default">Generate Payroll <i class="fa fa-plus"></i></a></div>
            <br/>
            <div class="clear-fix">
              <table id="bootstrap-data-table" class="table table-striped table-bordered table-responsive" style="width:1020px;overflow-x:scroll;">
                <thead>
                  <tr>
