...
<div class="payslip">
		...
		<tr>
			...
			<td>
				...
				<div class="mon">
                    ...
                    ?>
					<h4>NPS Report from <?php echo $from_date.' - '.$fromdate[1] ; ?> to <?php echo $to_date.' - '.$todate[1] ; ?> </h4>
				</div>
			</td>
  ...
  //echo $result . "Rupees  " . $points . " Paise"; ?>
				<td style="font-weight:600;" colspan="5">Total in words: RUPEES <?php echo strtoupper($result); ?>  </td>
