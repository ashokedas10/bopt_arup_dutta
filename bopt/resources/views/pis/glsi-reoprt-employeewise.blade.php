...
<html lang="en">
<head>
  <title>Board of Practical Training | Professional Tax</title>
  <meta charset="utf-8">
		...
		<tr>
			...
			<td>
				...
				<div class="mon">
                    ...
                    ?>
					<h4>GSLI Report from <?php echo $from_date.' - '.$fromdate[1] ; ?> to <?php echo $to_date.' - '.$todate[1] ; ?></h4>
				</div>
			</td>
			...
			<tr>
				<td colspan="3" style="padding-bottom: 25px;">In respect of Shri/Smt:  <u><?php echo $employee_ptax[0]->emp_name; ?></u>,  Designation: <u><?php echo $employee_ptax[0]->emp_designation;  ?></u>,  Emp-Code: <u><?php echo $employee_ptax[0]->employee_id; ?></u>, PAN No.: <u><?php echo $employee_ptax[0]->emp_pan_no; ?></u></td>
			</tr>
		<?php } ?>
		</table>	
			...
			<table border="1" class="sal-det" style="width:100%;border-collapse:collapse;border-color:#cacaca;">
				...
				<thead>
					<tr>
						<th>Sl. No.</th>
						<th>Month</th>
						<th>GSLI (<i class="fas fa-rupee-sign"></i>)</th>
				...
				<tbody>
					...
					$total_calculation=0;
					$i=1;
					if(!empty($employee_ptax))
						{ foreach($employee_ptax as $val){?>
					<tr class="part">
						<td style="text-align: center;"><?php echo $i;  ?></td>
						<td style="text-align: center;"><?php echo $val->month_yr;  ?></td>
						<td style="text-align:right;"><?php echo $val->emp_gslt;  ?></td>
						<td style="text-align:right;"><?php echo $total =$val->emp_gslt; 
