            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
					...
					<div class="emp-descp-main">
								...
								<div class="col-md-4 emp-desc">Employee Id: <span>{{ $LoanApply[0]->employee_code }}</span></div>

							        <div class="col-md-4 emp-desc">Loan Status: <span>{{ $LoanApply[0]->loan_status }}</span></div>
                                                                <div class="col-md-4 emp-desc">Applied Date: <span>{{ $LoanApply[0]->apply_date }}</span></div>
