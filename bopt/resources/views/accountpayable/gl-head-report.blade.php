...
<div class="payslip">
        ...
        <tr>
            ...
            <td>
                <div class="text-center pay-head">
                    ...
                    <h4>Details of  @if(!empty($gl_entries)) {{ $gl_entries[0]['account_head'] }} @endif as on {{ date('Y') }}-{{ $financial_year }}</h4>
                </div>
    ...
    background:#ddd;">
        <tr>
            ...
            <th class="left" style="padding: 5px; width:40%;">Particulars</th>
            <th class="right" style="padding: 5px; width:30%;">Amount</th>
        </tr>
        </thead>
        @if(!empty($gl_entries))
        @php $amount = 0; @endphp
        ...
        <tr>
            ...
            <td>{{ $gl_entry['sub_account_name'] }}</td>

            <td class="right">{{ $gl_entry['payable_amt'] }}</td>
        </tr>

        @php $amount += $gl_entry['payable_amt']; @endphp
        @endforeach
        ...
        <tr>
            <td colspan="2" class="right" style="border-right:none;">Total</td>
