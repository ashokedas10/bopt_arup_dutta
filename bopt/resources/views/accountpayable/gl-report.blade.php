...
<html lang="en">
<head>
  <title>Board of Practical Training | General Ledger Report</title>
  <meta charset="utf-8">
...
<table border="1" style="width:100%;border-collapse:collapse;">
	...
	<tbody>
		<tr>
			...
			<td style="padding:3px;">01/04/2019</td>
		...
		<tr>
			...
			<td style="padding:3px;">{{ $currentlist['credit_name'] }}<br>Narration:<br>{{ $currentlist['narration'] }}</td>
			<td style="padding:3px;">{{ $currentlist['voucher_type'] }}</td>
			<td style="padding:3px;"></td>
			<td style="padding:3px;"></td>
			<td style="padding:3px;"></td>
			<td style="padding:3px;"></td>
			<td style="padding:3px;" class="right">{{ $currentlist['amount'] }}</td>
