                    ...
                    <div class="main-card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Exam Type</strong>
                            </div>
							@if(Session::has('message'))										
									<div class="alert alert-success" style="text-align:center;"><span class="glyphicon glyphicon-ok" ></span><em > {{ Session::get('message') }}</em></div>
							@endif	
							<div class="aply-lv" style="padding-right: 36px;">
								<a href="{{ url('sms/exam-management/exam-type') }}" class="btn btn-default">Add New Exam Type <i class="fa fa-plus"></i></a>
							</div>
                            <div class="card-body">
							...
							<div class="srch-rslt" style="overflow-x:scroll;">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
										@foreach($exam_type_rs as $exam)
                                        <tr>
$                                           <td>{{ $exam->exam_type_name }}</td>
											<td>{{ $exam->exam_type_status }}</td>
