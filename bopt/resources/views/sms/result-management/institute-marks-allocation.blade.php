        ...
        <div class="main-card">
          <div class="card">
							<div class="card-header">
                                 <strong class="card-title">Add Mrks Allocation</strong>
                            </div>
							<div class="card-body">
								<form action="{{ url('sms/result-management/institute-marks-allocation') }}" method="post" enctype="multipart/form-data" style="width:800px;margin:0 auto;padding: 30px 0 10px;">
