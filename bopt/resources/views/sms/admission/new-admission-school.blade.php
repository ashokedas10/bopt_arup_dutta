...
<style>
 ul#stepForm, ul#stepForm li {
  ...
  label{margin-top: 10px;}
	  .help-inline-error{color:red;}#sf3 .form-control {height: 39px;}.table td, .table th{vertical-align:middle;}.table thead th{vertical-align:middle;} .table thead{background: #d0e7ef;} .card form label{font-size:13px;}input[type=checkbox], input[type=radio]{margin-right:3px;}
</style>
  ...
  <div class="content">
    ...
    <div class="panel-body">
      <form name="basicform" id="basicform" method="post" action="{{ url('sms/admission/new-admission-school') }}" enctype="multipart/form-data" >
        <input type="hidden" name="_token" value="{{ csrf_token() }}" >
        <div id="sf1" class="frm">
          <fieldset>
            <legend>Admission &amp; Student Basic Information</legend>

            <div class="row form-group">
              <div class="col-md-4">
                    <label for="text-input" class=" form-control-label">Institute Name</label>
                    <input type="text" class="form-control" readonly="" name="institute_name"  value="{{ $data->institute_name }}" >
					<input type="hidden" name="institute_code" id="institute_code" value="{{ $data->institute_code }}" >
                  </div>
			  
			   <div class="col-md-4">
                    <label for="text-input" class=" form-control-label">Class Applied for</label>
                    <input type="text" class="form-control" readonly="" name="class_name" value="{{ $data->class_name }}">
					  <input type="hidden" name="class_code" id="class_code" value="{{ $data->class_code }}" >
                  </div>
              <div class="col-md-4">
					<label>Session</label>
					 <input type="text" readonly="" class="form-control" placeholder="2018" name="session" id="session"  value="{{ $data->session}}" >
				</div>
            </div>
			...
			<div class="row form-group">
				...
				<div class="col-md-3">
				  <label>Select Blood Group</label>
                    <select name="b_group" class="form-control" name="blood_group"  >
                   	<option value="" selected disabled>Select</option>
			...
			<div class="row form-group">
				...
				<div class="col-md-3">
				<label>Scholer Type</label>
				<select name="cast_cat" class="form-control" name="school_type">
				<option value="">Select</option>
                    <option value="Scholer Type1">Scholer Type1</option>
                  </select>
				</div>
				<div class="col-md-6">
				  	<label>Second Language Opted for (KG onwards)</label>
					<input type="text" class="form-control" name="second_language">
				  </div>
			...
			<div class="row form-group">
				<div class="col-md-4">
				<label>Student Passport Size Photograph</label>
        ...
        <div id="sf2" class="frm" style="display: none;">
          <fieldset>
			...
			<div class="col-md-3">
				...
				<div class="col-md-3">
				<label>Father's Name of Company</label>
					<input type="text" class="form-control" name="fathers_company_name" >
				</div>
			...
			<div class="col-md-3">
				...
				<div class="col-md-3">
				<label>Mother's Name of Company</label>
					<input type="text" class="form-control" name="mothers_company_name" >
				</div>
			...
			<div class="row form-group">
				...
				<label>Mother's Designation</label>
					<input type="email" class="form-control" name="mothers_designation" >
				</div>
				<div class="col-md-4">
				...
				<label>Mother's Phone No.</label>
					<input type="text" class="form-control" name="mothers_ph_no">
				</div>
			...
			<div class="row form-group">
				<div class="col-md-4">
				<label>Father's Photograph</label>
					<input type="file" class="form-control" style="height:39px;" name="fathers_photo" >
				</div>
				<div class="col-md-4">
				<label>Mother's Photograph</label>
					<input type="file" class="form-control" style="height:39px;" name="mothers_photo">
				</div>
				<div class="col-md-4">
				<label>Total Family Income</label>
					<input type="text" class="form-control" name="tot_family_income">
				</div>
			...
			<div class="row form-group">
			<div class="col-md-12">
				<label style="padding-right:15px;">Whether capable of spending Rs. 70,000/- to 90,000/- annually, for this purpose of your child's education</label>	
				<label class="radio-inline">
                    <input type="radio" name="annually_spend" value="Yes">
                    Yes</label>
                    <label class="radio-inline">
                    <input type="radio" name="annually_spend" value="No">
                    No</label>
			</div>
			</div>
		...
		<legend>Parmanent Address <span><label class="checkbox-inline">
			...
			<div class="row form-group">
				<div class="col-md-12">
				<label style="padding-right:15px;">Hostel Accommodation?</label><label class="radio-inline">
							<input type="radio" name="hostel_accommodation" value="Yes">
							Yes</label>
						<label class="radio-inline" style="padding-right:25px;">
							<input type="radio" name="hostel_accommodation" value="No">
							No</label>
				
				<label style="padding-right:15px;">Transport Facility?</label><label class="radio-inline">
							<input type="radio" name="transport_facility" value="Yes" >
							Yes</label>
						<label class="radio-inline">
...
<script>
	...
	//$(document).ready(function(){
		...
		//{
			...
			$.ajax({
				type:'GET',
				url:'{{url('sms/admission/fees-heads-school')}}/'+institute_code+'/'+class_code+'/'+session,				
