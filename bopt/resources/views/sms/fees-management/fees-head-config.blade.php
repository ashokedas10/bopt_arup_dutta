      ...
      <div class="row">
		...
		<div class="card">
							<div class="card-header">
                                <strong class="card-title">Add Fees Configuration</strong>
                            </div>
							<div class="card-body">
								<form action="{{ url('sms/fees-management/fees-head-config') }}" method="post" enctype="multipart/form-data" style="width:800px;margin:0 auto;padding: 30px 0 10px;">
