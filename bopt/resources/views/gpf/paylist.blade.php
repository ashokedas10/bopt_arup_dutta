                ...
                <div class="main-card">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <strong class="card-title">  Payable</strong>
                        ...
                        <div class="card-body">
                            <div class="aply-lv" style="padding-right: 17px;margin-bottom:15px;">
                                <a href="{{ url('gpf/payview') }}" class="btn btn-default">Add  Payment <i class="fa fa-plus"></i></a>
                            </div>
...
{{--                                    <th>Vouchaer Date</th>--}}
                                ...
                                <tbody>
                                @foreach($payablelisting as $receivelist)
                                    <tr>
