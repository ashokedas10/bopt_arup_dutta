...
@section('content')
                ...
                <div class="main-card">
                    <div class="card">
                        <div class="card-header">
                            <strong>Add  Payable</strong>
                        </div>
                        <div class="card-body card-block">
                            <form action="{{ url('gpf/paysave') }}" method="post" enctype="multipart/form-data" id="payablebooking">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="voucher_type" id="voucher_type" class="form-control" required>
                                            ...
                                            <option value="received">GPF Payable</option>
                                        </select>
    ...
    <script>
        ...
        $("#getvoucher").click(function () {
            ...
            if(($('#account_head_id').val() == '') || ($('#sub_account_id').val() == '') || ($('#account_tool').val() == '')  || ($('#bill_amt').val() == '')  ){
            ...
            if(payment_booking_id == '' ) {
                $.ajax({
                    type:'GET',
                    url:'{{url('gpf/get-lastvoucherpqyno')}}/'+selectedsub_account_id,
...
$.ajax({
                                ...
                                success: function(responce)
                                {
                                    ...
                                    window.location='{{ url('gpf/paylist') }}';
                                    alert("Record save Successfully");
                                    // wait(1000).then(() => window.location='{{ url('accountreceivable/list') }}'); // 'Hello!
                                }
                            });
