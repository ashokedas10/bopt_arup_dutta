...
.pay-cont.yellow a {background: #f1b632;} 
...
.boxOuter2 .pay-icon{ width:50%; float:left; background:#7E3C94; text-align:center; min-height:217px; }
.boxOuter2 .pay-icon img{ width:75px; height:auto; text-align:center; display:block; margin:0px auto; }
.boxOuter2 .pay-cont{ width:50%; float:left; background:#ffffff; text-align:center; min-height:217px; }
...
.boxOuter3 .pay-cont{ width:100%; float:left; background:#ffffff; text-align:center; min-height:103px; padding:0px; margin:0px; }
...
.pay-cont.pink a {background: #b928a6;}
 .pay-icon.green {background: #27a527;padding: 20.5px 0;}
 .user-name {text-align: right;}
 .user-name h4 {color: #7e3c94;FONT-SIZE: 18px;margin-top: 15px;}
.user-name h4 span i{color:#7e3c94;}
.pay-icon.yellow {
    background: #f1b632;
   padding: 24px 0;
}
...
.pay-cont.ylw a {background: #f1b632;}
.pay-icon.pink.pnk-holi img {width: 73px;}
</style>
...
<div class="header">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="user-name">
					 <h4><i class="ti-user"></i> Welcome  {{auth()->user()->name}} <span><a href="{{url('mainLogout')}}" title="logout"><i class="ti-power-off"></i></a></span></h4> 
...
<div class="row">
	<div class="col-lg-3">
		<div class="pis-hd">
			<h2>D<span>AK Management</span></h2>
		</div>
		
            <div class="rice-logo" style="margin-top: 0px !important;">
                <a href="{{ url('dak/dak-receipt') }}"><img src="{{ asset('theme/images/bopt-logo.png')}}" alt="logo" style="max-width: 123px !important;margin-left:66px;transform: rotate(0deg)!important;"></a>
	</div>
	</div>
            <?php 
                    $payroll=''; 
...
@if(auth()->user()->user_type=='user')
    ...
    <?php if (in_array("Received", $submenuslist)) {?> 
            ...
            <div class="boxOuter">
				<div class="col-lg-3">
					...
					<div class="pay-cont">
						...
						<a href="{{ url('dak/dashboard') }}">Start</a>
					</div>
				</div>
			</div>
		<?php } ?>

        <?php if (in_array("Received Receipt", $submenuslist)) {?> 	
            <div class="boxOuter" style="float: left;">
                <div class="col-lg-3">
                     <div class="pay-icon green" style="padding: 46.3px 0;">
                   <i class="fa fa-file-text-o" aria-hidden="true" style="color: #fff;font-size: 50px;"></i>
                    </div>
                    <div class="pay-cont green">
                        <h3> Recieved Receipts</h3>
                        <div class="clearfix"></div>
                        <a href="{{ url('dak/fin/dashboard') }}" target="_blank">Start</a>
                    </div>
                </div>
            </div>                
        <?php } ?>   
            ...
            <div class="boxOuter" style="float: left;">
                <div class="col-lg-3">
                   ...
                   <i class="fa fa-file-text-o" aria-hidden="true" style="color: #fff;font-size: 50px;"></i>
                    ...
                    <div class="pay-cont green">
                        <h3> Received Receipt</h3>
                        <div class="clearfix"></div>
                        <a href="{{ url('dak/fin/dashboard') }}">Start</a>
                    </div>
                </div>
            </div>  
