...
<html lang="en">
<head>
  <title>Board of Practical Training | Schedule 22 | Prior period expenses</title>
  <meta charset="utf-8">
...
<table border="1" style="width:100%;border-collapse:collapse;">
	<thead>
		...
		<tbody>
                ...
                <tr>
                    <td class="sub">{{ $loop->iteration }}) {{ $schedule_expense['account_name'] }}({{ $sub_act['coa_code'] }})</td>
