...
<html lang="en">
<head>
  <title>Board of Practical Training | Schedule 17 | Administrative and General Expenses</title>
  <meta charset="utf-8">
...
<table class="comp-det" style="width:100%;">
		<tr>
            ...
            <tr><td colspan="2"><h4 style="text-decoration:underline;text-transform:uppercase;">Schedule 17 - Administrative and General Expenses</h4></td></tr>
		</table>
        <table>
...
<table border="1" style="width:100%;border-collapse:collapse;">
	<thead>
		...
		<tbody>
            ...
            @foreach($schedule_det as $schedule_17)

			<tr>
				<td style="padding:3px;">{{ $schedule_17['account_name'] }}</td>
                <td style="" class="sub">{{ $schedule_17['total_amount'] }}</td>
				<td style="" class="sub"></td>
            </tr>



            @php $total_amt += $schedule_17['total_amount']; @endphp
            @endforeach
