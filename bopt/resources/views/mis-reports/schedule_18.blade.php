...
<html lang="en">
<head>
  <title>Board of Practical Training | Schedule 18 | Transportation Expenses</title>
  <meta charset="utf-8">
...
<table class="comp-det" style="width:100%;">
		<tr>
            ...
            <tr><td colspan="2"><h4 style="text-decoration:underline;text-transform:uppercase;">Schedule 18 - Transportation Expenses</h4></td></tr>
		</table>
        <table>
...
<table border="1" style="width:100%;border-collapse:collapse;">
	<thead>
		...
		<tbody>
            ...
            @foreach($schedule_det as $schedule_18)

			<tr>
				<td style="padding:3px;">{{ $schedule_18['account_name'] }}</td>
				<td style="padding:3px; text-align: right;">{{ $schedule_18['total_amount'] }}</td>
				<td style="padding:3px;"></td>
            </tr>


            @php $total_amt += $schedule_18['total_amount']; @endphp
            @endforeach
