...
<html lang="en">
<head>
  <title>Board of Practical Training | Schedule 20 | Finance Costs</title>
  <meta charset="utf-8">
...
<table class="comp-det" style="width:100%;">
		<tr>
            ...
            <tr><td colspan="2"><h4 style="text-decoration:underline;text-transform:uppercase;">Schedule 20 - Finance Costs</h4></td></tr>
		</table>
        <table>
...
<table border="1" style="width:100%;border-collapse:collapse;">
	<thead>
		...
		<tbody>
			<tr>
				<td style="padding:3px;">a) Bank charges</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>

			<tr>
				<td style="padding:3px;">b) Others (specify)</td>
				<td style="padding:3px;" class="right"></td>
				<td style="padding:3px;" class="right"></td>
			</tr>
