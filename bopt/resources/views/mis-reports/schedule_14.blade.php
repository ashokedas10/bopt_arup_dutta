...
<html lang="en">
<head>
  <title>Board of Practical Training | Schedule 14 | Prior Period Income Income</title>
  <meta charset="utf-8">
...
<table class="comp-det" style="width:100%;">
		<tr>
            ...
            <tr><td colspan="2"><h4 style="text-decoration:underline;text-transform:uppercase;">Schedule 14 - Prior Period Income Income</h4></td></tr>
		</table>
        <table>
...
<table border="1" style="width:100%;border-collapse:collapse;">
	<thead>
		<thead style="background:#f5f4f4;">
			...
			<tr>
				<th style="padding:4px;width:50%;">Particulars</th>
				<th style="padding:4px;width:25%;">Current Year</th>
				<th style="padding:4px;width:25%;">Previous Year</th>
			</tr>

		</thead>
		<tbody>
			<tr>
				<td class="sub">1. Academic Receipts</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td class="sub">2. Income from Investments</td>
				<td style="padding:3px;" class="right">-</td>
				<td class="right" style="padding:3px;">-</td>
			</tr>
			<tr>
				<td class="sub">3. Interest earned</td>
				<td style="padding:3px;" class="right">-</td>
				<td class="right" style="padding:3px;">-</td>
			</tr>
			<tr>
				<td class="sub">4. Other Income</td>
				<td class="right" style="padding:3px;">-</td>
				<td class="right" style="padding:3px;">-</td>
			</tr>
			<tr>
				<td class="sub2">a) Income towards excess liability of pension written back</td>
				<td style="padding:3px;" class="right">-</td>
				<td class="right" style="padding:3px;">-</td>
			</tr>
