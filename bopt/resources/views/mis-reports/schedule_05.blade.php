...
<html lang="en">
<head>
  <title>Board of Practical Training | Schedule 5 | Investments from Earmarked/Endowment Funds</title>
  <meta charset="utf-8">
...
<table class="comp-det" style="width:100%;">
		<tr>
			...
			<tr><td colspan="2"><h4 style="text-decoration:underline;text-transform:uppercase;">Schedule 5 - Investments from Earmarked/Endowment Funds</h4></td>
		</table>
		<table>
		<tr>

		<th style="border-left:none;text-align:right;">Amount in Rupees</th></tr>
		</table>
	...
	<thead>
		...
		<tbody>
			<tr>
				...
				<td style="padding:3px;">In Central Government Securities</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td style="padding:3px;" class="center">2</td>
				<td style="padding:3px;">In State Government Securities</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td style="padding:3px;" class="center">3</td>
				<td style="padding:3px;">Other approved Securities</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td style="padding:3px;" class="center">4</td>
				<td style="padding:3px;">Shares</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td style="padding:3px;" class="center">5</td>
				<td style="padding:3px;">Debentures and Bonds</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td style="padding:3px;" class="center">6</td>
				<td style="padding:3px;">Term Deposit with Banks</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td style="padding:3px;" class="center">7</td>
				<td style="padding:3px;">Others (to be specified)</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>

			<tr>
				<td colspan="2" style="padding:3px;text-align:center;"><b>Total</b></td>
				<td class="right" style="padding:3px;">-</b></td>
...
<table>
    <tr><td colspan="2"><h4 style="text-decoration:underline;text-transform:uppercase;">Schedule 5(A) - Investments from Earmarked/Endowment Funds (Fund Wise)</h4></td></tr>
<tr>
...
<tbody>
    ...
    <tr>
        <td style="padding:3px;" class="center">5</td>
        <td style="padding:3px;">Endowment Fund Investments</td>
        <td style="padding:3px;" class="right">-</td>
        <td style="padding:3px;" class="right">-</td>
    </tr>
