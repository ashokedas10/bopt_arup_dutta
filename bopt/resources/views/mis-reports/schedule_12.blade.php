...
<html lang="en">
<head>
  <title>Board of Practical Training | Schedule 12 | Interest Earned</title>
  <meta charset="utf-8">
...
<table class="comp-det" style="width:100%;">
		<tr>
            ...
            <tr><td colspan="2"><h4 style="text-decoration:underline;text-transform:uppercase;">Schedule 12 - Interest Earned</h4></td></tr>
		</table>
        <table>
...
<table border="1" style="width:100%;border-collapse:collapse;">
	<thead>
		...
		<tbody>
            ...
            @foreach($schedule_det as $schedule_12)
            @if($schedule_12['account_name'] != '')
            <tr>
                {{-- <td style="padding:3px;"></td> --}}
				<td style="padding:3px;">{{ $schedule_12['sl_no'] }}{{ $schedule_12['account_name'] }}</td>
				<td class="right" style="padding:3px;">{{ $schedule_12['total_amount'] }}</td>
				<td class="right" style="padding:3px;">-</td>
            </tr>
            @elseif($schedule_12['coa_name'] != '')
            <tr>
                {{-- <td style="padding:3px;"></td> --}}
				<td style="padding-left:23px;">{{ $schedule_12['sl_no'] }}{{ $schedule_12['coa_name'] }}</td>
				<td class="right" style="padding:3px;"></td>
				<td class="right" style="padding:3px;">-</td>
            </tr>
            @endif
            @php $total_amt += $schedule_12['total_amount']; @endphp
            @endforeach

			<tr>
				<td colspan=""  style="padding:3px;" class="center"><b>Total</b></td>
