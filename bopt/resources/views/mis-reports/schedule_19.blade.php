...
<table class="comp-det" style="width:100%;">
		<tr>
            ...
            <tr><td colspan="2"><h4 style="text-decoration:underline;text-transform:uppercase;">Schedule 19 - Repairs &amp; Maintenance</h4></td></tr>
		</table>
        <table>
...
<table border="1" style="width:100%;border-collapse:collapse;">
	<thead>
		...
		<tbody>
            ...
            @foreach($schedule_det as $schedule_19)

            <tr>
                <td style="padding:3px;">{{ $schedule_19['sl_no'] }}</td>
				<td style="padding:3px;">{{ $schedule_19['account_name'] }}</td>
				<td style="padding:3px;" class="right">{{ $schedule_19['total_amount'] }}</td>
				<td style="padding:3px;" class="right">-</td>
            </tr>



            @php $total_amt += $schedule_19['total_amount']; @endphp
            @endforeach
