  ...
  <div class="content">
    ...
    <div class="animated fadeIn">
      ...
      <div class="row">
        <div class="main-card">
          <div class="card">
            <div class="card-header"><strong class="card-title">Add GRN for Item</strong></div>
            <div class="card-body card-block">
              <form action="{{ url('procurement/purchase/add-GRN-item') }}" method="post" enctype="multipart/form-data" style="padding:2% 5%;">
		...
		function getpostatus(val)
		{
			...
			if(val == 'with')
			{
				$.ajax({
					...
					url:'{{url('procurement/purchase/itemgrnwith-po')}}/'+val,
					type: "GET",
			...
			else
			{
				$.ajax({
					...
					url:'{{url('procurement/purchase/itemgrnwithout-po')}}/'+val,
					type: "GET",
