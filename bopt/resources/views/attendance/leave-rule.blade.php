                                ...
                                <form action="{{ url('leave-management/save-leave-rule') }}" method="post" enctype="multipart/form-data" class="form-horizontal" style="padding:5% 12%;">
                                    ...
                                    <div class="row form-group">
									 <input type="hidden" name="id" value="<?php  if(!empty($leave_rule_data->id)){echo $leave_rule_data->id;} ?>">
                                        ...
                                        <div class="col-md-4">
											...
											<input type="text" id="max_no" name="max_no" class="form-control" value="<?php  if(!empty($leave_rule_data->max_no)){echo $leave_rule_data->max_no;} ?>">
									...
									<div class="row form-group">
										...
										<div class="col-md-3">
											...
											<input type="text" id="max_balance_enjoy" name="max_balance_enjoy" class="form-control" value="<?php if(!empty($leave_rule_data->max_balance_enjoy)){ echo $leave_rule_data->max_balance_enjoy;}  ?>">
                                        ...
                                        <div class="col-md-3">
											...
											<input type="date" id="effective_from" name="effective_from" class="form-control" data-date-format="DD MMMM YYYY"  value="<?php  if(!empty($leave_rule_data->effective_from)){ echo $leave_rule_data->effective_from; } ?>">
                                        ...
                                        <div class="col-md-3">
											...
											<input type="date"  data-date-format="DD-MM-YYYY" id="effective_to" name="effective_to" class="form-control" value="<?php  if(!empty($leave_rule_data->effective_to)){ echo $leave_rule_data->effective_to; } ?>">
