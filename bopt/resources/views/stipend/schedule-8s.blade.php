...
<html lang="en">
<head>
  <title>Board of Practical Training | Finance Cost</title>
  <meta charset="utf-8">
...
<table class="comp-det" style="width:100%;">
		<tr>
			...
			<tr><td colspan="2"><h4 style="text-transform: uppercase;text-decoration:underline;">Schedule 8S - Finance Cost</h4></td></tr>
		</table>
		<table>
			<tr>
...
<table border="1" style="width:100%;border-collapse:collapse;border:1px solid #000;margin-bttom:10px;">
	...
	<tbody>
		<tr>
			<td><b>a) Bank Charges</b></td>
			<td class="right">{{$totalamout}}</td>
			<td class="right">-</td>
		</tr>

		<tr>
			<td><b>b) Others (Specify)</b></td>
			<td class="right">-</td>
			<td class="right">-</td>
		</tr>
