  	...
  	<div class="content">
	    ...
	    <div class="animated fadeIn">
	      ...
	      <div class="row">
	        <div class="main-card">
	          <div class="card">
	            <div class="card-header"> <strong> Receipts and Payments Account</strong> </div>
	            <div class="card-body card-block">
					...
					@endif
	            <form action="{{ url('receipt-payment') }}" method="post" style="width: 70%;margin: 0 auto;" target="_blank">
