  ...
  <nav class="navbar navbar-expand-sm navbar-default">
    <div id="main-menu" class="main-menu collapse navbar-collapse">
      <ul class="nav navbar-nav">
        <li class="active dashboard"><a href="{{ url('interview/dashboard') }}"><img src="{{ asset('images/dashboard-icon.png') }}" alt="" /> Dashboard</a></li>
        <li class="menu-item-has-children dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="{{ asset('images/time-sheet.png') }}" alt="" /> Interviewer Feedback</a>
          <ul class="sub-menu children dropdown-menu">
            <li><a href="{{ url('interview/interviewer-remarks') }}"><img src="{{ asset('images/view.png') }}" alt="" / style="margin-top:10px;"> Remarks</a></li>
          </ul>
        </li>
