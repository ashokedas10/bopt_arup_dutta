...
.boxOuter{ float:left !important; margin:0px 2px 0 0; padding:0px 10px; width:28% !important;margin-bottom:3px;}
.boxOuter .col-lg-3{ width:100%; max-width: 100%; padding:0px; margin:0px;} 



 
.boxOuter2{ float:left !important; margin:0px 2px 0px 0px; padding:0px 10px 0 0; width:44% !important;}
	...
	<div class="text-center col-lg-9" style="padding:0;">
		...
		<div class="boxOuter">
			<div class="col-lg-3">
				...
				<img src="{{ asset('images/payroll.png') }}" alt="payroll">
				</div>
				<div class="pay-cont">
					<h3>Indenting &amp; Requisition</h3>
					<div class="clearfix"></div>
					<a href="{{ url('procurement/indent/dashboard') }}" target="_blank">Start</a>
				</div>
			</div>
			</div>
			...
			<div class="col-lg-6">
				<div class="pay-icon">
				<img src="{{ asset('images/attedence-icon.png') }}" alt="payroll">
				</div>
				<div class="pay-cont">
					<h3>Inventory</h3>
					<div class="clearfix"></div>
					<a href="{{ url('procurement/inventory/dashboard') }}" target="_blank">Start</a>
				</div>
			</div>
			</div>
			...
			<div class="col-lg-3">
				<div class="pay-icon">
				<img src="{{ asset('images/leave-application-icon.png') }}" alt="payroll">
				</div>
				<div class="pay-cont">
					<h3>Purchase</h3>
					<div class="clearfix"></div>
					<a href="{{ url('procurement/purchase/dashboard') }}" target="_blank">Start</a>
				</div>
			</div>
			</div>
