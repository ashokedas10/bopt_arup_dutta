                ...
                <div class="lv-due" style="border:none;">
                    ...
                    <div class="row form-group">
					  ...
					  <div class="row form-group">
						...
						<div class="col-md-6">
					  	<label>Name</label>
						<input type="text" class="form-control" name="shipping_company" value="Board of Practical Training (Eastern Region)" readonly>
					  </div>
                          <div class="col-md-6">
                              <label>Address</label>
...
@include('procurement.purchase.partials.scripts')
  ...
  var tot_with_tax =tot_without_tax+final_gst_amount;
