...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2019 at 07:25 AM
...
(1, 'SBI', 'Saltlake', 'IFSC0987', '9876542', '2019-04-24 16:21:09.000000', '2019-04-24 16:21:09.000000', 'active'),
(2, 'PNB', 'Beleghata', 'IFSC0988', '987657777', '2019-04-24 16:21:09.000000', '2019-04-24 16:21:09.000000', 'active'),
(3, 'HDFC', 'Salt Lake', 'HDFC0023', 'TTTTTT', '2019-05-02 23:50:46.000000', '2019-05-02 23:50:46.000000', ''),
(4, 'hhh', 'fghgf', '456456', 'fghfg', '2019-05-31 06:53:36.000000', '2019-05-31 06:53:36.000000', 'active');
...
INSERT INTO `dak_final_details` (`id`, `dak_receipt_detail_id`, `dak_forward_no`, `status`, `created_at`, `updated_at`) VALUES
(2, 6, 'BOPT/DAK/FINAL/-2008-12-31 18:', 'reject', '2008-12-31 18:50:57', '0000-00-00 00:00:00');
...
CREATE TABLE `dak_forward_details` (
  ...
  `dak_status` enum('forward') NOT NULL,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 3, 'BOPT/DAK/F/-2019-05-31 07:42:3', 1, 2, 'forward', '2019-05-31 04:54:50', '0000-00-00 00:00:00'),
(4, 4, 'BOPT/DAK/F/-2019-05-31 06:42:3', 1001, 8, 'forward', '2019-05-31 06:42:38', '2019-05-31 01:12:38'),
(5, 6, 'BOPT/DAK/F/-2019-05-31 07:24:3', 1001, 2, 'forward', '2019-05-31 07:24:39', '2019-05-31 01:54:39');
...
CREATE TABLE `dak_receipt_details` (
  ...
  `doc_status` enum('receipt','forward','reject','accept') NOT NULL,
  `updated_at` timestamp(6) NULL DEFAULT NULL,
...
INSERT INTO `dak_receipt_details` (`id`, `diary_year`, `diary_date`, `receipt_type`, `receipt_category`, `reference_no`, `reference_date`, `sender_name`, `address`, `state`, `subject`, `remarks`, `dealing_head`, `enclosure_details`, `rec_lan`, `dairy_no`, `doc_status`, `updated_at`, `created_at`) VALUES
(3, 2019, '2019-05-08', 'Bill', 'Urgent', 321654, '2019-05-01', 'Rahul', 'Salt Lake', 'West Bengal', 'sdsds', 'Testing', NULL, 'sdsds sds dsd', 'English', 'BOPT/DAK-41-2019-05-27 05:33:08', 'forward', NULL, '2019-05-27 00:03:08.000000'),
(4, 2019, '2019-05-20', 'Proficiancy certificate', 'General', 321655, '2019-05-20', 'Ranjan', 'f dfd fdf df df', 'West Bengal', 'sdsds', 'Test', NULL, 'sdsds sds dsd', 'Hindi', 'BOPT/DAK-36-2019-05-27 05:36:13', 'forward', NULL, '2019-05-27 00:06:13.000000'),
(5, 2019, '2019-05-28', 'Proficiancy certificate', 'Urgent', 321654, '2019-05-29', 'Rahul', 'Test Address', 'West Bengal', 'sdsds', 'TEST', NULL, 'sdsds sds dsd', 'Hindi', 'BOPT/DAK-43-2019-05-27', 'receipt', NULL, '2019-05-27 06:15:06.740922'),
(6, 2019, '2019-05-31', 'Letter', 'General', 12345, '2019-05-31', 'EIT', 'Kolkata', 'West Bengal', 'Bill', 'TEST', NULL, 'tes', 'English', 'BOPT/DAK-41-2019-05-31', 'reject', NULL, '2019-05-31 07:17:21.852532');
...
(1, 'D0001', 'RECEPTIONS', 'Trash', '2019-03-25 06:49:52.000000', '2019-03-25 06:49:52.000000'),
(2, 'D0002', 'SOFTWARE DEVELOPMENT', 'active', '2019-03-25 06:50:31.000000', '2019-03-25 06:50:31.000000'),
(3, 'D0003', 'ACCOUNTS', 'active', '2019-03-25 06:50:58.000000', '2019-03-25 06:50:58.000000'),
(4, 'D0004', 'PAYROLL', 'active', '2019-03-25 06:52:11.000000', '2019-03-25 06:52:11.000000'),
(5, 'D0005', 'MARKETING', 'active', '2019-03-25 06:53:07.000000', '2019-03-25 06:53:07.000000'),
(6, 'D0006', 'Human Resource Management.', 'active', '2019-03-25 06:53:31.000000', '2019-03-25 06:53:31.000000'),
(7, 'D0007', 'PRODUCT DEVELOPMENT', 'active', '2019-03-25 06:55:55.000000', '2019-03-25 06:55:55.000000'),
(8, 'D0008', 'Quality Assurance', 'active', '2019-03-25 06:57:19.000000', '2019-03-25 06:57:19.000000'),
(9, 'D0009', 'Research and development', 'active', '2019-03-25 06:57:59.000000', '2019-03-25 06:57:59.000000'),
(10, 'D21', 'RECEPTION', 'Trash', '2019-04-01 03:10:22.000000', '2019-04-01 03:10:22.000000'),
(11, NULL, '456456', 'active', '2019-05-31 06:58:06.000000', '2019-05-31 06:58:06.000000');
...
(9, '2', NULL, 'NNN', '2019-05-23 02:21:46', '2019-05-23 02:21:46', 'active');
...
CREATE TABLE `employee_pay_structure` (
  ...
  `spcl_allowance` varchar(55) NOT NULL,
  `cash_handling_allowance` varchar(55) NOT NULL,
...
INSERT INTO `employee_pay_structure` (`id`, `employee_code`, `basic_pay`, `da`, `hra`, `trans_allowance`, `da_on_ta`, `ltc`, `cea`, `travelling_allowance`, `daily_allowance`, `advance`, `adjustment_advance`, `medical_reimbursement`, `spcl_allowance`, `cash_handling_allowance`, `gpf`, `nps`, `cpf`, `gsli`, `income_tax`, `cess`, `professional_tax`, `others`, `created_at`, `updated_at`) VALUES
(1, '1001', 45000, '1', '1', '1', '1', NULL, NULL, '1', NULL, NULL, NULL, NULL, '', '', NULL, '1', '1', NULL, NULL, '', NULL, NULL, '2019-05-30 20:46:45.000000', '2019-05-30 20:46:45.000000'),
(2, '101', NULL, '1', '1', '1', '1', NULL, NULL, '1', NULL, NULL, NULL, NULL, '', '', NULL, '1', NULL, '1', NULL, '', '1', NULL, '2019-05-31 00:31:00.000000', '2019-05-31 00:31:00.000000');
...
(10, 'rejoin', '2019-05-31 06:50:41.000000', '2019-05-31 06:50:41.000000', 'active');
...
,`emp_father_name` varchar(255)
,`emp_present_city_class` varchar(255)
,`emp_residential_distance` varchar(255)
,`emp_home_town` varchar(50)
,`emp_nearest_railway` varchar(50)
,`emp_caste` varchar(50)
,`emp_sub_caste` varchar(50)
,`emp_religion` varchar(50)
,`emp_spouse_working_status` varchar(50)
,`emp_government` varchar(50)
,`emp_spouse_quarter` varchar(50)
,`emp_branch` varchar(255)
,`emp_department` varchar(155)
,`emp_designation` varchar(155)
,`emp_eligible_promotion` varchar(155)
,`emp_doj` date
,`emp_retirement_date` date
,`emp_next_increament_date` date
,`emp_status` varchar(55)
,`emp_shift_group` varchar(255)
,`emp_from_date` date
,`emp_till_date` date
,`emp_x_qualification` varchar(255)
,`emp_x_dicipline` varchar(255)
,`emp_x_institute_name` varchar(255)
,`emp_x_board_name` varchar(255)
,`emp_x_pass_year` varchar(255)
,`emp_x_percentage` varchar(255)
,`emp_x_rank` varchar(255)
,`emp_xii_qualification` varchar(255)
,`emp_xii_dicipline` varchar(255)
,`emp_xii_institute_name` varchar(255)
,`emp_xii_board_name` varchar(255)
,`emp_xii_pass_year` varchar(255)
,`emp_xii_percentage` varchar(255)
,`emp_xii_rank` varchar(255)
,`emp_graduate_qualification` varchar(255)
,`emp_graduate_dicipline` varchar(255)
,`emp_graduate_institute_name` varchar(255)
,`emp_graduate_board_name` varchar(255)
,`emp_graduate_pass_year` varchar(255)
,`emp_graduate_percentage` varchar(255)
,`emp_graduate_rank` varchar(255)
,`emp_pgraduate_qualification` varchar(255)
,`emp_pgraduate_dicipline` varchar(255)
,`emp_pgraduate_institute_name` varchar(255)
,`emp_pgraduate_board_name` varchar(255)
,`emp_pgraduate_pass_year` varchar(255)
,`emp_pgraduate_percentage` varchar(255)
,`emp_pgraduate_rank` varchar(255)
,`nominee_name_one` varchar(255)
,`nominee_relationship_one` varchar(255)
,`nominee_age_one` varchar(255)
,`nominee_name_two` varchar(255)
,`nominee_relationship_two` varchar(255)
,`nominee_age_two` varchar(255)
,`emp_blood_group` varchar(25)
,`emp_eye_sight_left` varchar(35)
,`emp_eye_sight_right` varchar(35)
,`emp_family_plan_status` varchar(35)
,`emp_family_plan_date` varchar(35)
,`emp_height` varchar(55)
,`emp_weight` varchar(55)
,`emp_identification_mark_one` varchar(155)
,`emp_identification_mark_two` varchar(155)
,`emp_physical_status` varchar(55)
,`emp_pr_street_no` varchar(255)
,`emp_pr_city` varchar(55)
,`emp_pr_state` varchar(55)
,`emp_pr_country` varchar(155)
,`emp_pr_pincode` varchar(255)
,`emp_pr_mobile` varchar(255)
,`emp_ps_street_no` varchar(255)
,`emp_ps_city` varchar(255)
,`emp_ps_state` varchar(255)
,`emp_ps_country` varchar(255)
,`emp_ps_pincode` varchar(255)
,`emp_ps_phone` varchar(255)
,`emp_ps_mobile` varchar(255)
,`emp_ps_email` varchar(255)
,`emp_grade` varchar(50)
,`emp_group_name` varchar(255)
,`emp_pay_scale` varchar(255)
,`emp_pension_no` varchar(55)
,`emp_pf_type` varchar(55)
,`emp_passport_no` varchar(50)
,`emp_time_office_code` varchar(50)
,`emp_pf_no` varchar(50)
,`emp_pan_no` varchar(50)
,`emp_payment_type` varchar(50)
,`emp_bank_name` varchar(155)
,`emp_ifsc_code` varchar(155)
,`emp_account_no` varchar(155)
,`status` varchar(50)
);
...
(4, 'NEW G', '2019-05-31 06:51:17', '2019-05-31 06:51:17', 'active');
...
(7, '2019', '2019-04-19', '2019-04-19', 'Apr', '1', 'Good Friday', '2019-04-19 05:16:42.000000', '2019-04-19 05:16:42.000000'),
(8, '2020', '2019-05-24', '2019-05-31', 'Jun', '2', 'sdfsf', '2019-05-24 08:23:10.000000', '2019-05-24 08:23:10.000000'),
(9, '2021', '2019-05-25', '2019-05-31', 'Mar', '2', 'pi[oi', '2019-05-24 08:24:05.000000', '2019-05-24 08:24:05.000000');
...
(1, 1, 1, 9, 6, 3, '5/2019', '101', '2019-05-27 02:04:54.000000', '2019-05-27 02:04:54.000000', 'active'),
(2, 1, 1, 9, 2, 7, '6/2020', '200', '2019-05-27 02:04:54.000000', '2019-05-27 02:04:54.000000', 'active'),
(3, 1, 1, 9, 1, 8, '7/2020', '300', '2019-05-27 02:04:54.000000', '2019-05-27 02:04:54.000000', 'active'),
(4, 1, 1, 9, 5, 3, '5/2019', '1001', '2019-05-28 04:34:47.000000', '2019-05-28 04:34:47.000000', 'active');
...
(1, '101', 'Tirtha Aich Roy', '2019-05-28', '1', '2019-05-28', '2019-05-28', 1, 'APPROVED', '2019-05-28 04:38:06.000000', '2019-05-28 04:38:06.000000');
...
(1, 1, 12, 1, 9, 'yes', '2019-05-01', '2019-05-31', '2019-05-29 06:22:36.000000', '2019-05-29 06:22:36.000000', 'active');
...
(1, 'CASUAL LEAVE', 'CL', 'Casual Leave', '2019-05-24 09:28:21', '2019-05-24 03:56:57', 'active'),
(2, 'EARN LEAVE', 'EL', '', '2019-05-24 09:28:56', '0000-00-00 00:00:00', 'active'),
(3, 'HALF PAY LEAVE', 'HPL', '', '2019-05-24 09:29:40', '0000-00-00 00:00:00', 'active');
...
(11, 1, 3, 'Leave Rule', NULL, NULL),
(12, 1, 3, 'Leave Allocation', NULL, NULL),
(13, 1, 3, 'Leave Balance', NULL, NULL),
(14, 1, 3, 'Manage Leave Type', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `nps_details`
--
...
CREATE TABLE `nps_details` (
  ...
  `own_share` decimal(10,0) NOT NULL,
  `company_share` decimal(10,0) NOT NULL,
  `closing_balance` decimal(10,0) NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  `created_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `nps_details`
--

INSERT INTO `nps_details` (`id`, `emp_code`, `month_year`, `opening_balance`, `own_share`, `company_share`, `closing_balance`, `updated_at`, `created_at`) VALUES
(1, '202', '05/2019', '0', '5188', '5188', '10377', '2019-05-22 07:12:01', '2019-05-22 07:12:01'),
(2, '1001', '05/2019', '0', '4360', '4360', '8720', '2019-05-30 09:14:25', '2019-05-30 09:14:25');
...
--
-- Table structure for table `pay_scale_master`
--

CREATE TABLE `pay_scale_master` (
  `id` int(10) NOT NULL,
  `payscale_code` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `pay_scale_master`
--

INSERT INTO `pay_scale_master` (`id`, `payscale_code`) VALUES
(1, '2-V-I'),
(2, '2-V-II'),
(3, '2-V-III'),
(4, '2-V-IV');
...
CREATE TABLE `process_attendance` (
  ...
  `no_of_tour_leave` varchar(255) NOT NULL,
  `no_of_days_salary` varchar(255) NOT NULL,
  `updated_at` timestamp(6) NULL DEFAULT NULL,
  `created_at` timestamp(6) NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `process_attendance` (`id`, `employee_code`, `month_yr`, `no_of_working_days`, `no_of_days_absent`, `no_of_days_leave_taken`, `no_of_present`, `no_of_tour_leave`, `no_of_days_salary`, `updated_at`, `created_at`) VALUES
(1, 'E002', '01/2019', '22', '14', '0', 8, '0', '14', '2019-04-12 02:09:32.000000', '2019-04-12 02:09:32.000000'),
(2, 'E001', '01/2019', '22', '12', '1', 9, '0', '12', '2019-04-12 02:09:32.000000', '2019-04-12 02:09:32.000000'),
(3, '157', '04/2019', '22', '13', '0', 9, '0', '13', '2019-04-18 01:27:31.000000', '2019-04-18 01:27:31.000000'),
(4, '500', '04/2019', '21', '12', '0', 9, '0', '12', '2019-04-19 08:08:45.000000', '2019-04-19 08:08:45.000000'),
(16, 'E001', '05/2019', '22', '11', '0', 9, '2', '11', NULL, NULL),
(17, '202', '05/2019', '22', '0', '1', 9, '1', '22', NULL, NULL),
(18, '101', '05/2019', '23', '14', '0', 9, '0', '9', NULL, NULL),
(19, '1001', '05/2019', '23', '14', '0', 9, '0', '9', NULL, NULL);
...
(1, 2, 9, 50, 0, 100000, '2019-05-21 06:01:45', '0000-00-00 00:00:00'),
...
(24, 18, 4, 0, 0, 0, '2019-04-16 06:46:40', '0000-00-00 00:00:00'),
(25, 19, 0, 0, 0, 0, '2019-05-17 08:04:18', '0000-00-00 00:00:00'),
(26, 20, 0, 0, 0, 0, '2019-05-17 08:04:18', '0000-00-00 00:00:00');
...
CREATE TABLE `religion` (
  `id` int(11) NOT NULL,
  `religion_id` varchar(25) DEFAULT NULL,
...
(1, 'sutapa@tsap-kol.net', NULL, '1', '1', '1', 'Add', NULL, NULL),
(2, 'sutapa@tsap-kol.net', NULL, '1', '1', '1', 'Edit', NULL, NULL),
(3, 'sutapa@tsap-kol.net', NULL, '1', '1', '1', 'Delete', NULL, NULL),
(4, 'sutapa@tsap-kol.net', NULL, '1', '2', '2', 'Add', NULL, NULL),
(5, 'sutapa@tsap-kol.net', NULL, '1', '2', '2', 'Edit', NULL, NULL),
(6, 'sutapa@tsap-kol.net', NULL, '1', '2', '2', 'Delete', NULL, NULL),
(7, 'sutapa@tsap-kol.net', NULL, '1', '6', '7', 'Add', NULL, NULL),
(8, 'sutapa@tsap-kol.net', NULL, '1', '6', '7', 'Edit', NULL, NULL),
(9, 'sutapa@tsap-kol.net', NULL, '1', '6', '7', 'Delete', NULL, NULL),
(10, 'sutapa@tsap-kol.net', NULL, '1', '3', '4', 'Add', NULL, NULL),
(11, 'sutapa@tsap-kol.net', NULL, '1', '3', '4', 'Edit', NULL, NULL),
(12, 'sutapa@tsap-kol.net', NULL, '1', '3', '4', 'Delete', NULL, NULL),
(13, 'sutapa@tsap-kol.net', NULL, '1', '2', '3', 'Add', NULL, NULL),
(14, 'sutapa@tsap-kol.net', NULL, '1', '2', '3', 'Edit', NULL, NULL),
(15, 'sutapa@tsap-kol.net', NULL, '1', '2', '3', 'Delete', NULL, NULL),
(16, 'amit@tsap-kol.net', NULL, '1', '2', '2', 'Add', NULL, NULL),
(17, 'amit@tsap-kol.net', NULL, '1', '2', '2', 'Edit', NULL, NULL),
(18, 'amit@tsap-kol.net', NULL, '1', '2', '2', 'Delete', NULL, NULL),
(19, 'amit@tsap-kol.net', NULL, '1', '2', '3', 'Add', NULL, NULL),
(20, 'amit@tsap-kol.net', NULL, '1', '2', '3', 'Edit', NULL, NULL),
(21, 'amit@tsap-kol.net', NULL, '1', '2', '3', 'Delete', NULL, NULL),
(22, 'amit@tsap-kol.net', NULL, '1', '1', '1', 'Add', NULL, NULL),
(23, 'amit@tsap-kol.net', NULL, '1', '1', '1', 'Edit', NULL, NULL),
(24, 'amit@tsap-kol.net', NULL, '1', '1', '1', 'Delete', NULL, NULL);
...
CREATE TABLE `sub_cast` (
  ...
  `sub_cast_id` varchar(55) DEFAULT NULL,
...
(1, 'E001', '2019-05-07', '2019-05-08', '2019-05-09', '2', 'Way to Digha', 'NOT APPROVED', '2019-05-07 06:25:44.000000', '2019-05-07 06:25:44.000000'),
(2, '101', '2019-05-15', '2019-05-16', '2019-05-16', '1', 'office', 'NOT APPROVED', '2019-05-15 00:42:20.000000', '2019-05-15 00:42:20.000000');
...
(1, '101', 'Sutapa majumder', 'GS', '10:00', '18:00', '2019-05-01', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-27 18:30:00.000000'),
(2, '101', 'Sutapa majumder', 'GS', '10:00', '18:00', '2019-05-02', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-27 18:30:00.000000'),
(3, '101', 'Sutapa majumder', 'GS', '10:00', '18:00', '2019-05-03', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-27 18:30:00.000000'),
(4, '101', 'Sutapa majumder', 'GS', '10:00', '18:00', '2019-05-04', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-27 18:30:00.000000'),
(5, '101', 'Sutapa majumder', 'GS', '10:00', '18:00', '2019-05-05', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-27 18:30:00.000000'),
(6, '101', 'Sutapa majumder', 'GS', '10:00', '18:00', '2019-05-06', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-27 18:30:00.000000'),
(7, '101', 'Sutapa majumder', 'GS', '10:00', '18:00', '2019-05-07', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-27 18:30:00.000000'),
(8, '101', 'Sutapa majumder', 'GS', '10:00', '18:00', '2019-05-08', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-27 18:30:00.000000'),
(9, '101', 'Sutapa majumder', 'GS', '10:00', '18:00', '2019-05-09', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-27 18:30:00.000000'),
(10, '1001', 'Sutapa majumder', 'GS', '10:00', '18:00', '0000-00-00', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-29 18:30:00.000000'),
(11, '1001', 'Sutapa majumder', 'GS', '10:00', '18:00', '0000-00-00', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-29 18:30:00.000000'),
(12, '1001', 'Sutapa majumder', 'GS', '10:00', '18:00', '0000-00-00', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-29 18:30:00.000000'),
(13, '1001', 'Sutapa majumder', 'GS', '10:00', '18:00', '0000-00-00', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-29 18:30:00.000000'),
(14, '1001', 'Sutapa majumder', 'GS', '10:00', '18:00', '0000-00-00', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-29 18:30:00.000000'),
(15, '1001', 'Sutapa majumder', 'GS', '10:00', '18:00', '0000-00-00', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-29 18:30:00.000000'),
(16, '1001', 'Sutapa majumder', 'GS', '10:00', '18:00', '0000-00-00', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-29 18:30:00.000000'),
(17, '1001', 'Sutapa majumder', 'GS', '10:00', '18:00', '0000-00-00', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-29 18:30:00.000000'),
(18, '1001', 'Sutapa majumder', 'GS', '10:00', '18:00', '0000-00-00', '05/2019', 'Present', '8 Hours 0 Minutes', '0000-00-00 00:00:00.000000', '2019-05-29 18:30:00.000000');
...
INSERT INTO `users` (`id`, `employee_id`, `name`, `email`, `user_type`, `password`, `remember_token`, `status`, `updated_at`, `created_at`) VALUES
(1, 'AD001', 'Admin', 'admin@bopt.com', 'admin', '$2y$10$tR3rDGqRAkGZbzagOeTMCuhmdchQc4DsR3pa6Weyw3dM0/2UeVYEy', 'wResMM5f2BlXgOR7wSMeVQFfkKVO67OsRuadxXsy79DftfNW4aHebZaVnmKe', 'active', NULL, NULL),
(21, '101', 'sutapa sinha roy', 'sutapa@tsap-kol.net', 'user', '$2y$10$WTsTev.Rsb53IOtI4kPR2ucYsiCJZBEdYw/iUHId4KDEpIEOqSaQa', 'Rsbxt7awWGgr91r8tkL4G6S9bIURhoM86WhH7WyDZf5gKSh1jigiwMZWJ9EH', 'active', '2019-05-23 01:51:07.000000', '2019-05-23 01:51:07.000000'),
(22, '200', 'amit', 'amit@tsap-kol.net', 'user', '$2y$10$GbM5l08/lyS5BIeJ8Zvi3un8X7UTdGVoSucZYbBVNvgHqKeAlowSa', '0W7nz4thfGdg9LrRqeQySvgCgnJk0zoHcRgpxPeR6K9Blhf5L80k0tsdJypW', 'active', '2019-05-23 01:51:07.000000', '2019-05-23 01:51:07.000000'),
(23, '1001', 'Tirtha Aich Roy', 'tirtha.kalyani@gmail.com', 'user', '$2y$10$hUJ1VDLEzgmpRs9bUzjKpOJX.VsHgLsFNl.rke/Ro9gDIi2Aqd7/q', 'IcO5GcdiU4a2EblHlS9FIRgEUfoT04EWas6hysJz7PhmEQGUBcYk9KO77q3m', 'active', '2019-05-28 04:35:32.000000', '2019-05-28 04:35:32.000000');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `emp_details`  AS  select `employee`.`id` AS `id`,`employee`.`emp_code` AS `emp_code`,`employee`.`emp_fname` AS `emp_fname`,`employee`.`emp_mname` AS `emp_mname`,`employee`.`emp_lname` AS `emp_lname`,`employee`.`emp_father_name` AS `emp_father_name`,`employee`.`emp_present_city_class` AS `emp_present_city_class`,`employee`.`emp_residential_distance` AS `emp_residential_distance`,`employee`.`emp_home_town` AS `emp_home_town`,`employee`.`emp_nearest_railway` AS `emp_nearest_railway`,`employee`.`emp_caste` AS `emp_caste`,`employee`.`emp_sub_caste` AS `emp_sub_caste`,`employee`.`emp_religion` AS `emp_religion`,`employee`.`emp_spouse_working_status` AS `emp_spouse_working_status`,`employee`.`emp_government` AS `emp_government`,`employee`.`emp_spouse_quarter` AS `emp_spouse_quarter`,`employee`.`emp_branch` AS `emp_branch`,`employee`.`emp_department` AS `emp_department`,`employee`.`emp_designation` AS `emp_designation`,`employee`.`emp_eligible_promotion` AS `emp_eligible_promotion`,`employee`.`emp_doj` AS `emp_doj`,`employee`.`emp_retirement_date` AS `emp_retirement_date`,`employee`.`emp_next_increament_date` AS `emp_next_increament_date`,`employee`.`emp_status` AS `emp_status`,`employee`.`emp_shift_group` AS `emp_shift_group`,`employee`.`emp_from_date` AS `emp_from_date`,`employee`.`emp_till_date` AS `emp_till_date`,`employee`.`emp_x_qualification` AS `emp_x_qualification`,`employee`.`emp_x_dicipline` AS `emp_x_dicipline`,`employee`.`emp_x_institute_name` AS `emp_x_institute_name`,`employee`.`emp_x_board_name` AS `emp_x_board_name`,`employee`.`emp_x_pass_year` AS `emp_x_pass_year`,`employee`.`emp_x_percentage` AS `emp_x_percentage`,`employee`.`emp_x_rank` AS `emp_x_rank`,`employee`.`emp_xii_qualification` AS `emp_xii_qualification`,`employee`.`emp_xii_dicipline` AS `emp_xii_dicipline`,`employee`.`emp_xii_institute_name` AS `emp_xii_institute_name`,`employee`.`emp_xii_board_name` AS `emp_xii_board_name`,`employee`.`emp_xii_pass_year` AS `emp_xii_pass_year`,`employee`.`emp_xii_percentage` AS `emp_xii_percentage`,`employee`.`emp_xii_rank` AS `emp_xii_rank`,`employee`.`emp_graduate_qualification` AS `emp_graduate_qualification`,`employee`.`emp_graduate_dicipline` AS `emp_graduate_dicipline`,`employee`.`emp_graduate_institute_name` AS `emp_graduate_institute_name`,`employee`.`emp_graduate_board_name` AS `emp_graduate_board_name`,`employee`.`emp_graduate_pass_year` AS `emp_graduate_pass_year`,`employee`.`emp_graduate_percentage` AS `emp_graduate_percentage`,`employee`.`emp_graduate_rank` AS `emp_graduate_rank`,`employee`.`emp_pgraduate_qualification` AS `emp_pgraduate_qualification`,`employee`.`emp_pgraduate_dicipline` AS `emp_pgraduate_dicipline`,`employee`.`emp_pgraduate_institute_name` AS `emp_pgraduate_institute_name`,`employee`.`emp_pgraduate_board_name` AS `emp_pgraduate_board_name`,`employee`.`emp_pgraduate_pass_year` AS `emp_pgraduate_pass_year`,`employee`.`emp_pgraduate_percentage` AS `emp_pgraduate_percentage`,`employee`.`emp_pgraduate_rank` AS `emp_pgraduate_rank`,`employee`.`nominee_name_one` AS `nominee_name_one`,`employee`.`nominee_relationship_one` AS `nominee_relationship_one`,`employee`.`nominee_age_one` AS `nominee_age_one`,`employee`.`nominee_name_two` AS `nominee_name_two`,`employee`.`nominee_relationship_two` AS `nominee_relationship_two`,`employee`.`nominee_age_two` AS `nominee_age_two`,`employee`.`emp_blood_group` AS `emp_blood_group`,`employee`.`emp_eye_sight_left` AS `emp_eye_sight_left`,`employee`.`emp_eye_sight_right` AS `emp_eye_sight_right`,`employee`.`emp_family_plan_status` AS `emp_family_plan_status`,`employee`.`emp_family_plan_date` AS `emp_family_plan_date`,`employee`.`emp_height` AS `emp_height`,`employee`.`emp_weight` AS `emp_weight`,`employee`.`emp_identification_mark_one` AS `emp_identification_mark_one`,`employee`.`emp_identification_mark_two` AS `emp_identification_mark_two`,`employee`.`emp_physical_status` AS `emp_physical_status`,`employee`.`emp_pr_street_no` AS `emp_pr_street_no`,`employee`.`emp_pr_city` AS `emp_pr_city`,`employee`.`emp_pr_state` AS `emp_pr_state`,`employee`.`emp_pr_country` AS `emp_pr_country`,`employee`.`emp_pr_pincode` AS `emp_pr_pincode`,`employee`.`emp_pr_mobile` AS `emp_pr_mobile`,`employee`.`emp_ps_street_no` AS `emp_ps_street_no`,`employee`.`emp_ps_city` AS `emp_ps_city`,`employee`.`emp_ps_state` AS `emp_ps_state`,`employee`.`emp_ps_country` AS `emp_ps_country`,`employee`.`emp_ps_pincode` AS `emp_ps_pincode`,`employee`.`emp_ps_phone` AS `emp_ps_phone`,`employee`.`emp_ps_mobile` AS `emp_ps_mobile`,`employee`.`emp_ps_email` AS `emp_ps_email`,`employee`.`emp_grade` AS `emp_grade`,`employee`.`emp_group_name` AS `emp_group_name`,`employee`.`emp_pay_scale` AS `emp_pay_scale`,`employee`.`emp_pension_no` AS `emp_pension_no`,`employee`.`emp_pf_type` AS `emp_pf_type`,`employee`.`emp_passport_no` AS `emp_passport_no`,`employee`.`emp_time_office_code` AS `emp_time_office_code`,`employee`.`emp_pf_no` AS `emp_pf_no`,`employee`.`emp_pan_no` AS `emp_pan_no`,`employee`.`emp_payment_type` AS `emp_payment_type`,`employee`.`emp_bank_name` AS `emp_bank_name`,`employee`.`emp_ifsc_code` AS `emp_ifsc_code`,`employee`.`emp_account_no` AS `emp_account_no`,`employee`.`status` AS `status` from `employee` ;
...
--
-- Indexes for table `dak_final_details`
--
ALTER TABLE `dak_final_details`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dak_forward_details`
--
ALTER TABLE `dak_forward_details`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dak_receipt_details`
--
ALTER TABLE `dak_receipt_details`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `nps_details`
--
ALTER TABLE `nps_details`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `pay_scale_basic_master`
--
ALTER TABLE `pay_scale_basic_master`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pay_scale_master`
--
...
--
-- AUTO_INCREMENT for table `dak_final_details`
--
ALTER TABLE `dak_final_details`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `dak_forward_details`
--
ALTER TABLE `dak_forward_details`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `dak_receipt_details`
--
ALTER TABLE `dak_receipt_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT for table `nps_details`
--
ALTER TABLE `nps_details`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `pay_scale_basic_master`
--
ALTER TABLE `pay_scale_basic_master`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `pay_scale_master`
--
ALTER TABLE `pay_scale_master`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
